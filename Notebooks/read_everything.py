...
def read_everything():
    ...
    fullsed_path = '/content/drive/MyDrive/Be-HDUST/Project_Lband_v3/Study_OldBeAtlas/OldBeAtlas/fullsed_v5/'
    source_path = '/content/drive/MyDrive/Be-HDUST/Project_Lband_v3/Study_OldBeAtlas/OldBeAtlas/source_v4/'
    #source_path = '../OldBeAtlas/source/'
    #temps_path = '../OldBeAtlas/temperatures_v2/'
    temps_path = '/content/drive/MyDrive/Be-HDUST/Project_Lband_v3/Study_OldBeAtlas/OldBeAtlas/temperatures_v2/'
